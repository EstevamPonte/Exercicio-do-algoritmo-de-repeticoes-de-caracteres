...
describe('AlgoritmosCompressao class', () => {
	...
	it('Testa o metodo descomprimeFequenciaCaractere com o texto A2B12C', () => {
		const example: AlgoritmosCompressao = new AlgoritmosCompressao();
		const param: string = 'A2B2C';
	...
	it('Testa o metodo descomprimeFequenciaCaractere com o texto A', () => {
		const example: AlgoritmosCompressao = new AlgoritmosCompressao();
		const param: string = 'A';
		const returnValue: string = example.descomprimeFequenciaCaractere(param);
		expect(returnValue).to.equal('A', 'returns the value passed as a parameter');
	});
	it('Testa o metodo descomprimeFequenciaCaractere com o texto A100B', () => {
		const example: AlgoritmosCompressao = new AlgoritmosCompressao();
		const param: string = 'A90B';
		const returnValue: string = example.descomprimeFequenciaCaractere(param);
	...
	it('Testa o metodo descomprimeFequenciaCaractere com o texto A3B', () => {
		const example: AlgoritmosCompressao = new AlgoritmosCompressao();
		const param: string = 'A3B';
		const returnValue: string = example.descomprimeFequenciaCaractere(param);
		expect(returnValue).to.equal('ABBB', 'returns the value passed as a parameter');
	});
